...
Tennessee, Texas, Utah) -- including the automatic split into multiple files
by the 2,000-per-layer rule described below (California splits into 11 files
at 20,197 nodes; Texas into 9 files at 16,382 nodes).
